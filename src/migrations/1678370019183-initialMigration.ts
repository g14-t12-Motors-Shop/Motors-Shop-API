...
export class initialMigration1678370019183 implements MigrationInterface {
    name = 'initialMigration1678370019183'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "vehicles" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "title" character varying(50) NOT NULL, "price" numeric(8,2) NOT NULL, "year" integer NOT NULL, "mileage" integer NOT NULL, "vehicleType" character varying(50) NOT NULL, "description" character varying(500) NOT NULL, "isActive" boolean NOT NULL DEFAULT true, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "ownerId" uuid, CONSTRAINT "PK_18d8646b59304dce4af3a9e35b6" PRIMARY KEY ("id"))`);
